from databricks_example.tasks.sample_etl_task import SampleETLTask
from databricks_example.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/databricks-example/sample_experiment"
    }
