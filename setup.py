...
from databricks_example import __version__
...
setup(
    ...
    entry_points = {
        "console_scripts": [
            "etl = databricks_example.tasks.sample_etl_task:entrypoint",
            "ml = databricks_example.tasks.sample_ml_task:entrypoint",
    ]},
    version=__version__,
    description="",
    author="",
